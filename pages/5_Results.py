...
with col1:
    st.image('https://raw.githubusercontent.com/BipinChowdary/projectfuel.github.io/main/images/output.png')
with col2:
    st.image('https://raw.githubusercontent.com/BipinChowdary/projectfuel.github.io/main/images/output2.png')   
