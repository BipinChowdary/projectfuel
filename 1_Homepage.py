...
if st.button("💻 Open Project Code"):
    ...
    st.markdown("<script>window.open('https://github.com/your_project_repo', '_blank')</script>", unsafe_allow_html=True)

if st.button("🌐 Visit My Portfolio"):
    st.write("[Click here to visit My Portfolio](https://yourportfolio.com)")
    st.markdown("<script>window.open('https://yourportfolio.com', '_blank')</script>", unsafe_allow_html=True)
